        ...
        <div className="container" style={{ padding: "clamp(36px,5vw,58px) 0" }}>
          ...
          <div className="qm-stat-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "clamp(16px,3vw,40px)" }}>
            {([
              ...
              { n: 5, suf: "", label: "Regulatory Bodies", sub: "AWQAF · EHKAAM · REGA · Housing · SPGA" },
              { n: null, label: "Kingdom-Wide Focus", sub: "Saudi Arabia exclusive operations" },
            ] as const).map((s, i) => (
      ...
      <section className="section-lux" style={{ position: "relative", overflow: "hidden" }}>
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <div className="split-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(48px,7vw,100px)", alignItems: "center" }}>
            ...
            <ImageReveal delay={0.1} style={{ aspectRatio: "4/5", minHeight: 460, borderRadius: "clamp(16px,2vw,28px)" }}>
