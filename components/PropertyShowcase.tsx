    ...
    <div className="grid-3 qm-prop-grid" dir={rtl ? "rtl" : undefined}>
      ...
      <style>{`
        ...
        .qm-prop-img-wrap{
          ...
          box-shadow:0 4px 0 rgba(20,23,31,0.08),0 24px 60px rgba(20,23,31,0.16),0 0 0 1px rgba(20,23,31,0.06);
          transition:transform .5s cubic-bezier(.25,.46,.45,.94), box-shadow .5s ease;
        }
        .qm-prop-img-wrap:hover{ transform:translateY(-6px); box-shadow:0 4px 0 rgba(20,23,31,0.10),0 32px 80px rgba(20,23,31,0.24),0 0 0 1px rgba(176,141,87,0.30); }
        .qm-prop-img{
        ...
        .qm-prop-ghost{
          position:absolute; top:clamp(10px,1.6vw,18px); right:clamp(14px,2vw,22px);
        ...
        .qm-prop-pill{
          position:absolute; top:clamp(14px,2vw,22px); left:clamp(14px,2vw,22px);
        ...
        .qm-prop-copy{ position:absolute; left:0; right:0; bottom:0; padding:clamp(18px,2.4vw,28px); }
