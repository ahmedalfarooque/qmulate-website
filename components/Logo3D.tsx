...
export function Logo3D({ size = 336 }: { size?: number }) {
  ...
  return (
    <div style={{ position: 'relative', width: s, perspective: 900 }}>
      ...
      <div style={{
        ...
        height: s * 1.2,
        borderRadius: '50%',
        background: 'radial-gradient(ellipse, rgba(91,124,250,0.18) 0%, rgba(0,196,204,0.06) 50%, transparent 75%)',
        filter: 'blur(24px)',
        pointerEvents: 'none',
        zIndex: 0,
        animation: 'qlogo-halo 6s ease-in-out infinite',
      }}/>
      ...
      <motion.div
        ...
        style={{
          ...
          filter: 'drop-shadow(0 0 48px rgba(91,124,250,0.38)) drop-shadow(0 0 16px rgba(0,196,204,0.18))',
        }}
      >
        {strata.map((stratum, i) => (
            ...
            style={{
              ...
              background: i === 0
                ...
                : `linear-gradient(135deg,
                    rgba(255,255,255,${0.10 + (3 - i) * 0.07}) 0%,
                    ${stratum.color} 45%,
                    rgba(255,255,255,0.03) 100%)`,
              boxShadow: i === 0
                ? `0 0 36px rgba(91,124,250,0.60),
                   0 0 72px rgba(91,124,250,0.25),
                   0 0 4px rgba(0,196,204,0.40),
                   inset 0 1.5px 0 rgba(255,255,255,0.38),
                   inset 0 -1.5px 0 rgba(0,0,60,0.35)`
                : `0 0 14px ${stratum.glowColor}44,
                   0 2px 12px rgba(0,0,0,0.25),
                   inset 0 1px 0 rgba(255,255,255,0.20),
                   inset 0 -1px 0 rgba(0,0,0,0.22)`,
              border: i === 0
                ? '1px solid rgba(142,170,255,0.70)'
          ...
          >
            ...
            <div style={{
              ...
              width: '65%',
              height: '48%',
              background: 'linear-gradient(135deg, rgba(255,255,255,0.30) 0%, transparent 100%)',
