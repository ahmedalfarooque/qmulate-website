...
const SERVICE_LAYERS = [
  { label: "هيكلة الملكية",      sub: "الاستشارات العقارية · أطر الملكية · حوكمة القرارات · وضوح طويل المدى",     color: "var(--gold)" },
  { label: "إدارة الأصول",        sub: "إدارة الأملاك · التأجير · التشغيل · الصيانة · الحفاظ على القيمة",   color: "var(--cyan)" },
  { label: "التطوير والاستثمار",  sub: "الوساطة العقارية · الفرص الاستثمارية · إعادة تموضع الأصول · النمو المستدام",           color: "var(--blue)" },
];
          ...
          <div className="container">
            <div className="hero-split-grid" style={{ display: "grid", gridTemplateColumns: "1.05fr 0.95fr", gap: "clamp(40px,6vw,96px)", alignItems: "center", direction: "rtl" }}>
              ...
              <div style={{ textAlign: "right" }}>
                ...
                >
                  منصة عقارية متكاملة تقدم خدمات الاستشارات العقارية والوساطة العقارية وإدارة الأملاك
                  للعائلات والشركات والأفراد، مع التركيز على الحفاظ على القيمة وتحقيق نمو مستدام على المدى الطويل.
                </motion.p>
            ...
            <div>
              ...
              <Reveal direction="right" delay={0.2}>
                <p style={{ fontSize: "clamp(15px,1.3vw,18px)", lineHeight: 1.95, color: "var(--text-3)", marginBottom: 40, textAlign: "right" }}>
                  ندعم ملاك العقارات والعائلات والشركات والأوقاف من خلال خدمات الاستشارات
                  العقارية والوساطة العقارية وإدارة الأملاك، ضمن إطار واضح ومنظم يسهّل
                  اتخاذ القرار ويعزز الاستدامة على المدى الطويل. ومن خلال الجمع بين الخبرة
                  العقارية وأفضل الممارسات المؤسسية، نساعد على تعزيز أداء الأصول والحفاظ
                  على قيمتها ودعم نموها المستدام بمرور الوقت.
                </p>
              </Reveal>
