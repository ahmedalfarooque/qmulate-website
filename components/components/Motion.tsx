...
// ══════════════════════════════════════════════════════════════
// GLOW ORB — animated ambient orb
// ══════════════════════════════════════════════════════════════

export function AnimatedOrb({
  color="#00D4FF", size=400, top, left, right, bottom,
  opacity=0.12, period=24, delay=0,
}: {
  color?:string; size?:number;
  top?:string; left?:string; right?:string; bottom?:string;
  opacity?:number; period?:number; delay?:number;
}) {
  const should = useReducedMotion();
  return (
    <motion.div
      ...
      transition={{
        duration:period, delay, repeat:Infinity,
        ease:"easeInOut", times:[0,.4,.7,1],
      }}
    />
  );
}
...
// ══════════════════════════════════════════════════════════════
// TIMELINE NODE — animated dot that draws in
// ══════════════════════════════════════════════════════════════
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        width:active?18:12, height:active?18:12, borderRadius:"50%",
        background:active?color:"rgba(255,255,255,.2)",
        boxShadow:active?`0 0 0 4px ${color}33, 0 0 28px ${color}88`:undefined,
        zIndex:2,
      }}
    >
      {active && (
        <motion.div
          ...
          animate={{ scale:[1,1.6], opacity:[.7,0] }}
