      ...
      <section className="svc-hero" dir="rtl">
        ...
        <div className="container svc-hero-inner">
          <div className="svc-hero-copy">
            ...
            >
              من خلال تقديم خدمات الاستشارات العقارية والوساطة العقارية
              وإدارة الأملاك، نساعد مالك العقارات والعائلات والشركات
              والأوقاف على تعزيز أداء الأصول، والاستفادة من الفرص،
              وتحقيق قيمة مستدامة.
            </motion.p>
          ...
          <div className="about-split">
            ...
            <div className="about-narrative" style={{ textAlign:"right" }}>
              ...
              <LineReveal delay={0.08} style={{ marginTop:18 }}>
                <h2 className="t-h2 gt-w">منصة عقارية متكاملة متخصصة في الاستشارات العقارية والوساطة العقارية وإدارة الأملاك.</h2>
              </LineReveal>

              <motion.p {...FU(.16)} className="t-md about-narrative-p">
                تقدم كيوموليت خدمات عقارية متكاملة تشمل الاستشارات والوساطة
                وإدارة الأملاك وهيكلة الملكية، بما يلبي احتياجات الأفراد
                والعائلات والشركات والأوقاف في مختلف أنحاء المملكة.
              </motion.p>
